...
Then make exactly one non-watching \`gh-axi pr checks <number>\` read.
...
This label is presentation only: do not poll, do not append \`paused:\` for the checks, and do not wait for them before reporting done.
