...
The presentation owner bounds only the free worker-authored reason, so the canonical PR URL, Europe/Berlin timestamp, and healthy-worker label always stay complete.
