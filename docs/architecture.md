...
Ordinary detail caps remain for every unrelated row, a secondmate row keeps its first three waits complete with the remainder counted, and the home's remaining non-wait holds stay listed under those caps.
